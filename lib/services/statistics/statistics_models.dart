...
class RangeBucket {
  ...
  const RangeBucket(this.label, this.from, this.to);
}

// RangeDistribution Modell
class RangeDistribution {
  final String spieltyp;
  final List<RangeBucket> buckets;
...
class PairResult {
  ...
  List<PairEntry> get sortedEntries {
    final sorted = List<PairEntry>.from(entries);
